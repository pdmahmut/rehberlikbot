...
--
--  Bu dosya supabase/migrations/ altindaki tum gocleri sirasiyla birlestirir.
--  Yeni ve BOS bir Supabase projesinde bir kez calistirilir.
--
--  Icinde tablo olusturma, silme ve yeniden olusturma adimlari birlikte var;
--  bunlar projenin gecmisidir ve sirayla uygulandiginda dogru son duruma
--  ulasir. Kurulum bitince semanin dogrulugu ayrica karsilastirilacak.
-- =====================================================================
