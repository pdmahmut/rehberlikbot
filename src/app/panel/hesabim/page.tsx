...
export default function HesabimPage() {
  ...
  return (
    <div className="mx-auto max-w-xl space-y-5">
        ...
        <CardContent className="space-y-4 pt-5">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowOldPassword((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowConfirmPassword((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400">
      ...
      {role === "admin" && <LessonHoursSettings />}
    </div>
  );
}
